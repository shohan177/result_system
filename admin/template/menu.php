  ...
  <aside class="bg-black aside-md hidden-print hidden-xs" id="nav">
    <section class="vbox">
        ...
        <footer class="footer hidden-xs no-padder text-center-nav-xs">
            ...
            <a href="#nav" data-toggle="class:nav-xs" class="btn btn-icon icon-muted btn-inactive m-l-xs m-r-xs"> <i class="i i-circleleft text"></i> 
                <i class="i i-circleright text-active"></i> </a>
        </footer>
    </section>
</aside>