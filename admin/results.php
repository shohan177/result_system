                ...
                <div class="modal-body">
                    ...
                    <form id = "result_add_form" action="" method="POST">
                        <div class="form-group">
                            ...
                            <input id="student_search" name="student_id" class="form-control">
                            <input name="exm" type="hidden" id="exm">
                        </div>
                        ...
                        <div class="form-group pull-in clearfix ">
                                <div id="sub_ban" class="col-sm-4 hide">
                                    <label>Bangla 1</label>
                                     <input name="bng" type="text" class="form-control "  />
                                </div>
                                <div id="sub_ban2" class="col-sm-4 hide">
                                    <label>Bangla 2 </label>
                                     <input name="bng2" type="text" class="form-control "  />
                                </div>
                                <div id="sub_eng" class="col-sm-4 hide">
                                    <label>English 1</label> 
                                    <input name="eng" type="text" class="form-control " />
                                </div>
                                <div id="sub_eng2" class="col-sm-4 hide">
                                    <label>English 2</label> 
                                    <input name="eng2" type="text" class="form-control " />
                                </div>
                                ...
                                <div id="sub_hmath" class="col-sm-4 hide">
                                    ...
                                    <input name="hmat" type="text" class="form-control " />
                                </div>
                                <div id="sub_reli" class="col-sm-4 hide" hide>
                                    <label>Religion</label>
                                     <input name="reli" type="text" class="form-control "  />
                                </div>
                                <div id="sub_scien" class="col-sm-4 hide">
                                    <label>Science</label> 
                                    <input name="sci" type="text" class="form-control " />
                                </div>
                                <div id="sub_socal" class="col-sm-4 hide">
                                    <label>Socal</label> 
                                    <input name="soc" type="text" class="form-control " />
                                </div>
                                <div id="sub_phy" class="col-sm-4 hide">
                                    <label>Physic 1</label> 
                                    <input name="phy" type="text" class="form-control " />
                                </div>
                                <div id="sub_phy2" class="col-sm-4 hide">
                                    <label>Physic 2</label> 
                                    <input name="phy2" type="text" class="form-control " />
                                </div>
                                <div id="sub_chy" class="col-sm-4 hide">
                                    <label>Chimistry 1</label> 
                                    <input name="chy" type="text" class="form-control " />
                                </div>
                                <div id="sub_chy2" class="col-sm-4 hide">
                                    <label>Chimistry 2</label> 
                                    <input name="chy2" type="text" class="form-control " />
                                </div>
                                ...
                                <div id="sub_bio2" class="col-sm-4 hide">
                                    ...
                                    <input name="bio2" type="text" class="form-control " />
                                </div>
